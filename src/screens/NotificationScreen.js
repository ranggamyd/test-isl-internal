...
import { getData, saveData, getLang } from '../utils/database';
...
const NotificationScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        getResponse();
        getLang().then((lang) => setCurrentLang(lang || 'en-US'));
    }, []);
    ...
    const handlePress = async (id) => {
        ...
        setData(updatedData);
        await saveData('notification', updatedData);
    };
    ...
    const handleDeleteAll = async () => {
        Alert.alert(
            languages[currentLang].confirmDelete,
            languages[currentLang].confirmDeleteMessage,
            [
                { text: languages[currentLang].cancel, style: 'cancel' },
                {
                    text: languages[currentLang].deleteAll,
                    style: 'destructive',
                    onPress: async () => {
                        setData([]);
                        await saveData('notification', []);
    ...
    return (
        <>
            ...
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.headerText}>{languages[currentLang].notifications}</Text>
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        <TouchableOpacity onPress={handleDeleteAll}>
                            <Text style={styles.modalText}>{languages[currentLang].deleteAllNotification}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
